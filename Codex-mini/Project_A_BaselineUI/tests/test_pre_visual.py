...
def test_pre_visual_cards():
    ...
    with sync_playwright() as p:
        ...
        full_screenshot = SCREENSHOT_DIR / 'screenshot_pre_ui.png'
        page.screenshot(path=str(full_screenshot), full_page=True)
        test_screenshot = SCREENSHOT_DIR / 'screenshot_pre_baseline_visual.png'
        ...
        append_result({
            ...
            'details': 'Baseline dense layout captured for reference.',
        })
